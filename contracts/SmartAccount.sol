...
/**
 * The contract is a Smart Account, and all derived 'Smart Accounts' should match the bytecode
 * of a known 'good SmartAccount' version. See the 'SmartAccountRegistry' contract
 * for a mechanism for verifying valid SmartAccounts.
 */
...
contract SmartAccount {
    ...
    /**
     * Constructor of the Smart Account
     */
     ...
     * This could allow the account to be moved to a multi-sig contract.
    ...
    /**
     * This function removes the override by the owner - if trust between the account
